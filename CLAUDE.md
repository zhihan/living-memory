...
Small Group is a recurring-schedule platform built on Firebase and Firestore. The core domain includes `Room`, `Series`, `Occurrence`, `CheckIn`, notification, study/cohort, and assistant flows.
